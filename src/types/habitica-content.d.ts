...
export type HabiticaGearGroups = {
    ...
    warrior?: { [key: string]: HabiticaGearItem };
    rogue?: { [key: string]: HabiticaGearItem };
    wizard?: { [key: string]: HabiticaGearItem };
    healer?: { [key: string]: HabiticaGearItem };
    special: { [key: string]: HabiticaGearItem };
    mystery: { [key: string]: HabiticaGearItem };
    armoire?: { [key: string]: HabiticaGearItem };
}
